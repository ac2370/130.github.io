// heart-market.js - 心意集市（双钱包 · 自定义商品 · 送出记录收礼人）
(function() {
    'use strict';
    ...
    function _postGiftMoment(opts) {
        ...
        var post = {
            ...
            giftImage: opts.item.image || '',
            giftName: opts.item.name,
            giftNote: opts.note || '',
            giftText: giftText,
            giftFrom: opts.giftFrom || 'me',
            giftTo: opts.giftTo || ''    // ← 新增：收礼人
        };
    ...
    console.log('[心意集市] 模块已加载（双钱包 · 自定义商品 · 记录收礼人）');
})();
